...
- ⚠️ **거짓 진술 문항에만 해설이 붙는다 — 과목 공통 패턴이다.** 참 진술 문항은 정답만 나온다(딥러닝 2주차 Q1·Q4 거짓=해설 있음 / Q2·Q3 참=해설 없음, 문제해결프로그래밍입문 1주차 동일)
...
**6. ⚠️ 빈 해설은 추출 실패가 아니다 — 거짓 진술 문항에만 해설이 붙는다**

- **거짓 진술 문항에만 공식 해설이 붙고, 참 진술 문항은 정답만 나온다**
- 실측(딥러닝 2주차) — Q1·Q4(거짓)에는 해설이 있고 **Q2·Q3(참)에는 없다**
- 문제해결프로그래밍입문 1주차에도 같은 구조가 기록돼 있다 → **과목 공통 패턴**으로 본다
